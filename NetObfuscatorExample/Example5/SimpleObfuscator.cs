...
namespace Example5
{
    internal class SimpleObfuscator
    {
        ...
        private void ProtectStrings(MethodDef method)
        {
            ...
            for (int i = 0; i < instr.Count; i++)
            {
                ...
                if (instr[i].OpCode == OpCodes.Ldstr)
                {
                    ...
                    var splStr = SplitStringByCharToInstr(res, s);
        ...
        private List<Instruction> SplitStringByCharToInstr(Local res, string s)
        {
        ...
        {   
            ...
            {
                // add all instrnctions from the current simple block
